...
0000000000001163 <main>:
    ...
    1176:	eb 18                	jmp    1190 <main+0x2d>
    1178:	e8 cc ff ff ff       	call   1149 <f1>
    117d:	e8 1b 00 00 00       	call   119d <f2>
    1182:	e8 c2 ff ff ff       	call   1149 <f1>
    1187:	e8 11 00 00 00       	call   119d <f2>
    118c:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    1190:	83 7d fc 09          	cmpl   $0x9,-0x4(%rbp)
    1194:	7e e2                	jle    1178 <main+0x15>
...
000000000000119d <f2>:
    ...
    11a5:	48 8d 05 64 0e 00 00 	lea    0xe64(%rip),%rax        # 2010 <_IO_stdin_used+0x10>
    11ac:	48 89 c7             	mov    %rax,%rdi
    11af:	e8 9c fe ff ff       	call   1050 <puts@plt>
    11b4:	90                   	nop
    11b5:	5d                   	pop    %rbp
    11b6:	c3                   	ret
